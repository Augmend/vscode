...
suite('Workbench - TerminalWebLinkProvider', () => {
	...
	test('LinkComputer cases', async () => {
		...
		await assertLink('// https://github.com/projectkudu/kudu/blob/main/Kudu.Core/Scripts/selectNodeVersion.js', [{ range: [[4, 1], [9, 2]], text: 'https://github.com/projectkudu/kudu/blob/main/Kudu.Core/Scripts/selectNodeVersion.js' }]);
