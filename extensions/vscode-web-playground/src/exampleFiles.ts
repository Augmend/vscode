...
[![build status](https://travis-ci.org/Microsoft/vscode-mock-debug.svg?branch=main)](https://travis-ci.org/Microsoft/vscode-mock-debug)
[![build status](https://ci.appveyor.com/api/projects/status/empmw5q1tk6h1fly/branch/main?svg=true)](https://ci.appveyor.com/project/weinand/vscode-mock-debug)
